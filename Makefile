...
core_dir=plfsc_i8x4_inter_r3

server:
	make server_tcl_ooc core_dir=tb_i8x8_intra_r3
	make server_tcl_ooc core_dir=plsc_i8x4_inter_r2
	make server_tcl_ooc core_dir=plsc_i8x4_inter_r3
	make server_tcl_ooc core_dir=plsc_i8x8_inter_r2
	make server_tcl_ooc core_dir=plsc_i8x8_inter_r3
	make server_tcl_ooc core_dir=plfsc_i8x4_inter_r2
	make server_tcl_ooc core_dir=plfsc_i8x4_inter_r3
	make server_tcl_ooc core_dir=plfsc_i8x8_inter_r2
	make server_tcl_ooc core_dir=plfsc_i8x8_inter_r3

	# make server_tcl_ooc core_dir=origi
	# make server_tcl_ooc core_dir=ldpc_r2
	# make server_tcl_ooc core_dir=ldpc_r3
	# make server_tcl_ooc core_dir=plsc_r2
	# make server_tcl_ooc core_dir=plsc_r3
	# make server_tcl_ooc core_dir=ldpcnb_i8_r2
	# make server_tcl_ooc core_dir=ldpcnb_i8_r3
	# make server_tcl_ooc core_dir=tb_i8_r2
	# make server_tcl_ooc core_dir=tb_i8_r3
	# make server_tcl_ooc core_dir=ldpc_i8x4_inter_r2
	# make server_tcl_ooc core_dir=ldpc_i8x4_inter_r3
	# make server_tcl_ooc core_dir=ldpc_i8x8_inter_r2
	# make server_tcl_ooc core_dir=ldpc_i8x8_inter_r3
	# make server_tcl_ooc core_dir=plsc_i8x4_inter_r2
	# make server_tcl_ooc core_dir=plsc_i8x4_inter_r3
	# make server_tcl_ooc core_dir=plsc_i8x8_inter_r2
	# make server_tcl_ooc core_dir=plsc_i8x8_inter_r3
	...
	# make server_tcl_ooc core_dir=plfsc_i8x8_inter_r2
	# make server_tcl_ooc core_dir=plfsc_i8x8_inter_r3
	# make server_tcl_ooc core_dir=ldpcnb_i8x4_inter_r2
	# make server_tcl_ooc core_dir=ldpcnb_i8x4_inter_r3
	# make server_tcl_ooc core_dir=ldpcnb_i8x8_inter_r2
	# make server_tcl_ooc core_dir=ldpcnb_i8x8_inter_r3
	# make server_tcl_ooc core_dir=tb_i8x4_inter_r2
	# make server_tcl_ooc core_dir=tb_i8x4_inter_r3
	# make server_tcl_ooc core_dir=tb_i8x8_inter_r2
	# make server_tcl_ooc core_dir=tb_i8x8_inter_r3
	# make server_tcl_ooc core_dir=plsc_i8x4_intra_r2
	# make server_tcl_ooc core_dir=plsc_i8x4_intra_r3
	# make server_tcl_ooc core_dir=plsc_i8x8_intra_r2
	# make server_tcl_ooc core_dir=plsc_i8x8_intra_r3
	# make server_tcl_ooc core_dir=plfsc_i8x4_intra_r2
	# make server_tcl_ooc core_dir=plfsc_i8x4_intra_r3
	# make server_tcl_ooc core_dir=plfsc_i8x8_intra_r2
	# make server_tcl_ooc core_dir=plfsc_i8x8_intra_r3
	# make server_tcl_ooc core_dir=ldpcnb_i8x4_intra_r2
	# make server_tcl_ooc core_dir=ldpcnb_i8x4_intra_r3
	# make server_tcl_ooc core_dir=ldpcnb_i8x8_intra_r2
	# make server_tcl_ooc core_dir=ldpcnb_i8x8_intra_r3
	# make server_tcl_ooc core_dir=tb_i8x4_intra_r2
	# make server_tcl_ooc core_dir=tb_i8x4_intra_r3
	# make server_tcl_ooc core_dir=tb_i8x8_intra_r2
...
server_tcl_ooc:
	rm -rf core/
	cp -rf core.$(core_dir) core
	vivado -mode tcl -source get_alu.tcl -tclargs $(core_dir)
